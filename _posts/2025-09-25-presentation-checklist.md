...
- [ ] 計算ソフトウェアの変数名をそのまま使わず、物理的に正しい用語を用いているか？
    ex. Gaussian / wb97xd → ωB97X-D, hf → HF, 6-31g(d) → 6-31G(d), ...
        VASP / PE → PBE, ISIF = 1 → 構造最適化, ...
